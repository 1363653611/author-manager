 ...
 * @author zbcn8
 * @version 1.0.0
 * @ClassName GeneratorConstant.java
 * @Description 代碼生成常量
 * @createTime 2019年08月03日 10:22:00
 */
public class GeneratorConstant {
     ...
     * 数据库名称
     */
    public static final String DATABASE_NAME = "sys_author";

    /**
     * 生成代码的临时目录
     */
    public static final String TEMP_PATH = "zbcn_gen_temp/";
