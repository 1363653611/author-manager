 ...
 * @author zbcn8
 * @version 1.0.0
 * @ClassName AuthCaptchaUtil.java
 * @Description 验证码工具类，重写 {@link com.wf.captcha.utils.CaptchaUtil} 因为它没有提供修改验证码类型方法
 * @createTime 2019年08月11日 21:57:00
 */
@Slf4j
public class CaptchaUtil {
    ...
    public static boolean verify(String code, HttpServletRequest request) {
        ...
        String key = AuthorConstant.CODE_PREFIX + session.getId();
        String sessionCode = "";
        try {
